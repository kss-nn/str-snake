...
var Piece = /** @class */ (function () {
    function Piece(_a) {
        var x = _a.x, y = _a.y, _b = _a.type, type = _b === void 0 ? 'body' : _b, _c = _a.direction, direction = _c === void 0 ? 'RIGHT' : _c, _d = _a.next, next = _d === void 0 ? null : _d, _e = _a.prev, prev = _e === void 0 ? null : _e;
    ...
    Piece.prototype.isCollidingWith = function (node) {
    ...
    Piece.prototype.move = function (x, y, direction) {
        ...
        if (x < 0) {
            X = Utils_1["default"].snap(this.garden.clientWidth) - constants_1.SIZE;
        }
        else if (y < 0) {
            Y = Utils_1["default"].snap(this.garden.clientHeight) - constants_1.SIZE;
        }
        else if (x >= Utils_1["default"].snap(this.garden.clientWidth)) {
            X = 0;
        }
        else if (y >= Utils_1["default"].snap(this.garden.clientHeight)) {
            Y = 0;
        }
        // Save the old direction
        var tDirection = this.direction;
